...
namespace MegasoftDelayedPostingService
{
    class SysproCore
    {
        ...
        SYSPROWCFServicesClientLibrary40.SYSPROWCFServicesPrimitiveClient SysproWcf = new SYSPROWCFServicesClientLibrary40.SYSPROWCFServicesPrimitiveClient(Properties.Settings.Default.WcfBaseAddress, SYSPROWCFServicesClientLibrary40.SYSPROWCFBinding.NetTcp);
