...
var L_bobj_crv_Back = "Dozadu";
var L_bobj_crv_Forward = "Dopredu";
var L_bobj_crv_Page = "Strana";
var L_bobj_crv_PageNum = "Strana {0}";
...
var L_bobj_crv_InvalidPageNumber = "Zadajte \u010D\u00EDslo strany v\u00E4\u010D\u0161ie ako 0.";
var L_bobj_crv_ParamPanel = "Panel v\u00FDzvy";
var L_bobj_crv_Parameters = "Parametre";
var L_bobj_crv_GroupTree = "Strom skup\u00EDn";
var L_bobj_crv_Search = "H\u013Eada\u0165";
var L_bobj_crv_SearchResults = "V\u00FDsledky h\u013Eadania";
var L_bobj_crv_DrillUp = "Prejs\u0165 na vy\u0161\u0161iu \u00FArove\u0148";
var L_bobj_crv_DrillTo = "Z\u00EDska\u0165 podrobnosti o %1";
...
var L_bobj_crv_SearchText = "H\u013Eada\u0165";
var L_bobj_crv_SearchOptions = "Mo\u017Enosti h\u013Eadania";
var L_bobj_crv_Export = "Exportova\u0165 t\u00FAto zostavu";
var L_bobj_crv_Print = "Tla\u010Di\u0165 t\u00FAto zostavu";
var L_bobj_crv_History = "Hist\u00F3ria";
var L_bobj_crv_ClearHistory = "Vymaza\u0165 hist\u00F3riu";
var L_bobj_crv_TabList = "Zoznam kariet";
var L_bobj_crv_Minimize = "Minimalizova\u0165";
var L_bobj_crv_Logo=  "Logo Business Objects";
var L_bobj_crv_FileMenu = "Ponuka S\u00FAbor";
var L_bobj_crv_ResultsFound = "Po\u010Det n\u00E1jden\u00FDch v\u00FDsledkov: {0}";
var L_bobj_crv_ResultsFoundInSubreport = "Po\u010Det v\u00FDsledkov n\u00E1jden\u00FDch v umiestnen\u00ED {1}: {0}";
var L_bobj_crv_MatchWholeWordsOnly = "Iba cel\u00E9 slov\u00E1";
var L_bobj_crv_MatchCase = "Rozli\u0161ova\u0165 mal\u00E9 a ve\u013Ek\u00E9 p\u00EDsmen\u00E1";
var L_bobj_crv_FindMore = "H\u013Eada\u0165 \u010Falej";
var L_bobj_crv_Completed = "Dokon\u010Den\u00E9";
var L_bobj_crv_Breadcrumb= "Popis cesty";
...
var L_bobj_crv_ParamsCalBtn = "Kalend\u00E1r";
var L_bobj_crv_Reset= "Vynulova\u0165";
var L_bobj_crv_ResetTip = "Vynulova\u0165 hodnoty parametrov";
...
var L_bobj_crv_FlashRequired = "Tento obsah vy\u017Eaduje verziu Adobe Flash Player 11 alebo nov\u0161iu. {0}Kliknut\u00EDm sem ho nain\u0161talujete.";
...
var L_bobj_crv_LastRefreshed = "Naposledy obnoven\u00E9: {0}";

var L_bobj_crv_Collapse = "Zbali\u0165";

var L_bobj_crv_CatalystTip = "Zdroje online";
var L_bobj_crv_LoadingPage = "Na\u010D\u00EDtava sa str\u00E1nka {0}...";
var L_bobj_crv_TakeActionMenuTip = "Vybra\u0165 akciu v\u00E4zby";
var L_bobj_crv_TakeActionExecuteActionError = "Pri vykon\u00E1van\u00ED akcie sa vyskytol probl\u00E9m. Obr\u00E1\u0165te sa na spr\u00E1vcu.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(Nie s\u00FA dostupn\u00E9 \u017Eiadne akcie.)";

var L_bobj_crv_API_InvalidArray = "Polo\u017Eka {0} je typu pole";
var L_bobj_crv_API_InvalidBoolean = "Polo\u017Eka {0} je booleovsk\u00E9ho typu";
var L_bobj_crv_API_InvalidPageNumber = "Polo\u017Eka pageNumber je typu cel\u00E9 \u010D\u00EDslo a je v\u00E4\u010D\u0161ia ako 0";
var L_bobj_crv_API_InstantiationFailed = "Mus\u00ED sa vytvori\u0165 nov\u00E1 in\u0161tancia polo\u017Eky {0}.";
var L_bobj_crv_API_InvalidParamValue = "Hodnota po\u013Ea parametra {0} nie je platn\u00E1.";
var L_bobj_crv_API_InvalidParamType = "Typ po\u013Ea parametra {0} nie je platn\u00FD. Vyberte platn\u00FD typ z SAP.CR.Parameter.DataTypes";
var L_bobj_crv_API_InvalidParamName = "N\u00E1zov po\u013Ea parametra mus\u00ED by\u0165 re\u0165azec s d\u013A\u017Ekou v\u00E4\u010D\u0161ou ne\u017E 0.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} vy\u017Eaduje argumenty v po\u010Dte {1}";
var L_bobj_crv_API_InvalidValueType = "O\u010Dak\u00E1van\u00FD typ hodnoty tohto parametra je {0}.";
var L_bobj_crv_API_InvalidCanvasListener= "Prij\u00EDma\u010D mus\u00ED by\u0165 in\u0161tanciou SAP.CR.Viewer.CanvasListener";
var L_bobj_crv_API_InvalidActionListener= "Prij\u00EDma\u010D mus\u00ED by\u0165 in\u0161tanciou SAP.CR.Viewer.ActionListener";
var L_bobj_crv_API_ValueTypeUndefined= "Vlastnos\u0165 paramType po\u013Ea parametrov je neplatn\u00E1. Podporuj\u00FA sa iba hodnoty z polo\u017Eiek SAP.CR.Parameter.DataTypes.*.";
var L_bobj_crv_API_InvalidRangeBound = "Pre horn\u00FA a doln\u00FA hranicu sa m\u00F4\u017Eu pou\u017E\u00EDva\u0165 iba hodnoty z polo\u017Eky SAP.CR.Parameter.RangeBoundTypes";
var L_bobj_crv_API_InvalidBeginValue = "Po\u010Diato\u010Dn\u00E1 hodnota nie je platn\u00E1";
var L_bobj_crv_API_InvalidEndValue = "Koncov\u00E1 hodnota nie je platn\u00E1";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "Po\u010Diato\u010Dn\u00E1 hodnota mus\u00ED by\u0165 men\u0161ia alebo rovnak\u00E1 ako koncov\u00E1 hodnota";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "Hodnota dolnej a hornej hranice sa nem\u00F4\u017Ee rovna\u0165 polo\u017Eke SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "Po\u010Diato\u010Dn\u00E1 hodnota sa nem\u00F4\u017Ee rovna\u0165 koncovej hodnote.";
var L_bobj_crv_API_InvalidColor = "Farba {0} je neplatn\u00E1.";
var L_bobj_crv_API_InvalidResolution = "Rozl\u00ED\u0161enie {0} nie je platn\u00E9";
var L_bobj_crv_API_InvalidEventName = "{0} nie je platn\u00E1 udalos\u0165. Vyberte udalos\u0165 z ponuky {1}";
var L_bobj_crv_API_InvalidViewerName = "N\u00E1zov zobrazova\u010Da {0} m\u00E1 nespr\u00E1vny form\u00E1t. Mus\u00ED za\u010D\u00EDna\u0165 p\u00EDsmenom, za ktor\u00FDm m\u00F4\u017Ee nasledova\u0165 \u013Eubovo\u013En\u00FD po\u010Det p\u00EDsmen alebo \u010D\u00EDslic.";
var L_bobj_crv_API_ViewerInitFailed = "Nepodarilo sa inicializova\u0165 zobrazova\u010D";
var L_bobj_crv_API_ViewerLoadFailed = "Nepodarilo sa na\u010D\u00EDta\u0165 zobrazova\u010D";

var L_bobj_crv_API_InvalidPrintMode = "{0} nie je platn\u00FD re\u017Eim tla\u010De. Vyberte re\u017Eim tla\u010De z ponuky {1}";
var L_bobj_crv_API_InvalidReportMode = "{0} nie je platn\u00FD re\u017Eim zost\u00E1v. Vyberte re\u017Eim zost\u00E1v z ponuky {1}";
var L_bobj_crv_API_InvalidZoom = "{0} nie je platn\u00E1 \u00FArove\u0148 pribl\u00ED\u017Eenia";
var L_bobj_crv_API_InvalidFunction = "Prv\u00FD argument by mal by\u0165 funkciou";
var L_bobj_crv_API_InvalidFunctionAfterInit = "Funkciu {0} nemo\u017Eno vola\u0165 po inicializovan\u00ED zobrazova\u010Da.";
// <script>
/*
=============================================================
...
L_DHTMLLIB_month[0]="JANUÁR";
L_DHTMLLIB_month[1]="FEBRUÁR";
L_DHTMLLIB_month[2]="MAREC";
L_DHTMLLIB_month[3]="APRÍL";
L_DHTMLLIB_month[4]="MÁJ";
L_DHTMLLIB_month[5]="JÚN";
L_DHTMLLIB_month[6]="JÚL";
L_DHTMLLIB_month[7]="AUGUST";
L_DHTMLLIB_month[8]="SEPTEMBER";
L_DHTMLLIB_month[9]="OKTÓBER";
L_DHTMLLIB_month[10]="NOVEMBER";
L_DHTMLLIB_month[11]="DECEMBER";

L_DHTMLLIB_closeDialog="Zavrieť okno";

L_DHTMLLIB_openMenu="Kliknite sem pre prístup k možnostiam {0}";

L_DHTMLLIB_expandedLab="Rozbalené";
L_DHTMLLIB_collapsedLab="Zbalené";
L_DHTMLLIB_selectedLab="Vybrané";

L_DHTMLLIB_calendarNextMonthLab="Prejsť na nasledujúci mesiac";
L_DHTMLLIB_calendarPrevMonthLab="Prejsť na predchádzajúci mesiac";
L_DHTMLLIB_calendarNextYearLab="Prejsť na nasledujúci rok";
L_DHTMLLIB_calendarPrevYearLab="Prejsť na predchádzajúci rok";
L_DHTMLLIB_calendarSelectionLab="Vybraný deň";

L_DHTMLLIB_menuCheckLab="Začiarknuté";
L_DHTMLLIB_menuDisableLab="Vypnuté";
	
L_DHTMLLIB_level="Úroveň";
L_DHTMLLIB_closeTab="Zavrieť Kartu";
L_DHTMLLIB_of="z";

L_DHTMLLIB_helpLab="Pomocník";

L_DHTMLLIB_cancelButtonLab="Zrušiť";
