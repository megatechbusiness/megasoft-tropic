...
var L_bobj_crv_Back = "Voltar";
var L_bobj_crv_Forward = "Avan\u00E7ar";
...
var L_bobj_crv_InvalidPageNumber = "Especificar um n\u00FAmero de p\u00E1gina maior do que 0.";
var L_bobj_crv_ParamPanel = "Painel de prompt";
var L_bobj_crv_Parameters = "Par\u00E2metros";
var L_bobj_crv_GroupTree = "\u00C1rvore de Grupos";
var L_bobj_crv_Search = "Localizar";
var L_bobj_crv_SearchResults = "Resultados da localiza\u00E7\u00E3o";
var L_bobj_crv_DrillUp = "Pesquisar n\u00EDvel superior";
var L_bobj_crv_DrillTo = "Pesquisar %1";
...
var L_bobj_crv_SearchText = "Localizar";
var L_bobj_crv_SearchOptions = "Op\u00E7\u00F5es de localiza\u00E7\u00E3o";
var L_bobj_crv_Export = "Exportar este relat\u00F3rio";
var L_bobj_crv_Print = "Imprimir este relat\u00F3rio";
var L_bobj_crv_History = "Hist\u00F3rico";
var L_bobj_crv_ClearHistory = "Limpar hist\u00F3rico";
...
var L_bobj_crv_ResultsFoundInSubreport = "{0} resultados encotnrados em {1}";
var L_bobj_crv_MatchWholeWordsOnly = "Corresponder Somente Palavra Inteira";
var L_bobj_crv_MatchCase = "Diferenciar mai\u00FAsculas e min\u00FAsculas";
var L_bobj_crv_FindMore = "Localizar mais";
var L_bobj_crv_Completed = "Conclu\u00EDdo";
var L_bobj_crv_Breadcrumb= "Rastro da navega\u00E7\u00E3o";
...
var L_bobj_crv_ParamsApplyTip = "Aplicar valores do par\u00E2metro";
var L_bobj_crv_ParamsDlgTitle = "Inserir Valores";
var L_bobj_crv_ParamsCalBtn = "Calend\u00E1rio";
var L_bobj_crv_Reset= "Reconfigurar";
var L_bobj_crv_ResetTip = "Redefinir valores do par\u00E2metro";
...
var L_bobj_crv_FlashRequired = "Esse conte\u00FAdo requer o Adobe Flash Player 11 ou superior. {0}Clique aqui para instalar.";
...
var L_bobj_crv_LastRefreshed = "\u00DAltima atualiza\u00E7\u00E3o: {0}";

var L_bobj_crv_Collapse = "Recolher";

var L_bobj_crv_CatalystTip = "Recursos on-line";
var L_bobj_crv_LoadingPage = "Carregando p\u00E1gina {0}...";
var L_bobj_crv_TakeActionMenuTip = "Selecionar uma a\u00E7\u00E3o de liga\u00E7\u00E3o";
var L_bobj_crv_TakeActionExecuteActionError = "Houve um problema ao executar a a\u00E7\u00E3o; entre em contato com o administrador.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(Nenhuma a\u00E7\u00E3o dispon\u00EDvel)";

var L_bobj_crv_API_InvalidArray = "\'{0}\' \u00E9 do tipo Matriz";
var L_bobj_crv_API_InvalidBoolean = "\'{0}\' \u00E9 do tipo Booleano";
var L_bobj_crv_API_InvalidPageNumber = "\'pageNumber\' \u00E9 de tipo Inteiro e maior que 0";
var L_bobj_crv_API_InstantiationFailed = "Nova inst\u00E2ncia de {0} deve ser criada.";
var L_bobj_crv_API_InvalidParamValue = "O valor do campo de par\u00E2metro \'{0}\' n\u00E3o \u00E9 v\u00E1lido.";
var L_bobj_crv_API_InvalidParamType = "O tipo de campo de par\u00E2metro \'{0}\' n\u00E3o \u00E9 v\u00E1lido. Selecione um tipo v\u00E1lido em SAP.CR.Parameter.DataTypes";
var L_bobj_crv_API_InvalidParamName = "O nome do campo de par\u00E2metro deve ser uma string maior que 0.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} exige {1} argumentos.";
var L_bobj_crv_API_InvalidValueType = "O tipo do valor esperado para este par\u00E2metro \u00E9 \'{0}\'.";
var L_bobj_crv_API_InvalidCanvasListener= "O ouvinte deve ser uma inst\u00E2ncia do SAP.CR.Viewer.CanvasListener";
var L_bobj_crv_API_InvalidActionListener= "O ouvinte deve ser uma inst\u00E2ncia do SAP.CR.Viewer.ActionListener";
var L_bobj_crv_API_ValueTypeUndefined= "A propriedade paramType do campo de par\u00E2metros \u00E9 inv\u00E1lida. Somente valores de SAP.CR.Parameter.DataTypes.* s\u00E3o suportados.";
var L_bobj_crv_API_InvalidRangeBound = "Os limites superior e inferior s\u00F3 podem usar valores de SAP.CR.Parameter.RangeBoundTypes";
var L_bobj_crv_API_InvalidBeginValue = "O valor inicial n\u00E3o \u00E9 v\u00E1lido";
var L_bobj_crv_API_InvalidEndValue = "O valor final n\u00E3o \u00E9 v\u00E1lido";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "O valor inicial deve ser menor ou igual ao valor final";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "Os valores dos limites superior e inferior n\u00E3o podem ser iguais a SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "Os valores de in\u00EDcio e t\u00E9rmino n\u00E3o podem ser iguais.";
var L_bobj_crv_API_InvalidColor = "A cor \'{0}\' n\u00E3o \u00E9 v\u00E1lida.";
var L_bobj_crv_API_InvalidResolution = "A resolu\u00E7\u00E3o {0} n\u00E3o \u00E9 v\u00E1lida";
var L_bobj_crv_API_InvalidEventName = "\'{0}\' n\u00E3o \u00E9 um evento v\u00E1lido. Selecione um evento em {1}";
var L_bobj_crv_API_InvalidViewerName = "O nome do visualizador \'{0}\' est\u00E1 mal formado. Ele deve come\u00E7ar com uma letra e pode ser seguido por qualquer n\u00FAmero de letras ou d\u00EDgitos.";
var L_bobj_crv_API_ViewerInitFailed = "Falha ao inicializar o visualizador";
var L_bobj_crv_API_ViewerLoadFailed = "Falha ao inicializar o visualizador";

var L_bobj_crv_API_InvalidPrintMode = "\'{0}\' n\u00E3o \u00E9 um modo de impress\u00E3o v\u00E1lido. Selecione um modo de impress\u00E3o em {1}";
var L_bobj_crv_API_InvalidReportMode = "\'{0}\' n\u00E3o \u00E9 um modo de relat\u00F3rio v\u00E1lido. Escolha um modo de relat\u00F3rio em {1}";
var L_bobj_crv_API_InvalidZoom = "\'{0}\' n\u00E3o \u00E9 um n\u00EDvel de zoom v\u00E1lido";
var L_bobj_crv_API_InvalidFunction = "O primeiro argumento deve ser uma fun\u00E7\u00E3o.";
var L_bobj_crv_API_InvalidFunctionAfterInit = "\'{0}\' n\u00E3o pode ser chamado ap\u00F3s inicializa\u00E7\u00E3o do visualizador.";
// <script>
/*
=============================================================
...
L_DHTMLLIB_month[0]="JANEIRO";
L_DHTMLLIB_month[1]="FEVEREIRO";
L_DHTMLLIB_month[2]="MARÇO";
L_DHTMLLIB_month[3]="ABRIL";
L_DHTMLLIB_month[4]="MAIO";
L_DHTMLLIB_month[5]="JUNHO";
L_DHTMLLIB_month[6]="JULHO";
L_DHTMLLIB_month[7]="AGOSTO";
L_DHTMLLIB_month[8]="SETEMBRO";
L_DHTMLLIB_month[9]="OUTUBRO";
L_DHTMLLIB_month[10]="NOVEMBRO";
L_DHTMLLIB_month[11]="DEZEMBRO";

L_DHTMLLIB_closeDialog="Fechar Janela";

L_DHTMLLIB_openMenu="Clique aqui para acessar opções {0}";

L_DHTMLLIB_expandedLab="Expandido";
L_DHTMLLIB_collapsedLab="Recolhido";
L_DHTMLLIB_selectedLab="Selecionado";

L_DHTMLLIB_calendarNextMonthLab="Ir para o mês seguinte";
L_DHTMLLIB_calendarPrevMonthLab="Ir para o mês anterior";
L_DHTMLLIB_calendarNextYearLab="Ir para o próximo ano";
L_DHTMLLIB_calendarPrevYearLab="Ir para o ano anterior";
L_DHTMLLIB_calendarSelectionLab="Dia selecionado";

L_DHTMLLIB_menuCheckLab="Marcado";
L_DHTMLLIB_menuDisableLab="Desativado";
	
L_DHTMLLIB_level="Nível";
L_DHTMLLIB_closeTab="Fechar guia";
L_DHTMLLIB_of="de";

L_DHTMLLIB_helpLab="Ajuda";

L_DHTMLLIB_cancelButtonLab="Cancelar";
