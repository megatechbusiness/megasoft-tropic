...
var L_bobj_crv_ResultsFoundInSubreport = "{0} resultados encontrados en {1}";
...
L_DHTMLLIB_month[0]="ENERO";
L_DHTMLLIB_month[1]="FEBRERO";
L_DHTMLLIB_month[2]="MARZO";
L_DHTMLLIB_month[3]="ABRIL";
L_DHTMLLIB_month[4]="MAYO";
L_DHTMLLIB_month[5]="JUNIO";
L_DHTMLLIB_month[6]="JULIO";
L_DHTMLLIB_month[7]="AGOSTO";
L_DHTMLLIB_month[8]="SEPTIEMBRE";
L_DHTMLLIB_month[9]="OCTUBRE";
L_DHTMLLIB_month[10]="NOVIEMBRE";
L_DHTMLLIB_month[11]="DICIEMBRE";

L_DHTMLLIB_closeDialog="Cerrar ventana";

L_DHTMLLIB_openMenu="Haga clic aquí para acceder a las opciones de {0}";

L_DHTMLLIB_expandedLab="Expandido";
L_DHTMLLIB_collapsedLab="Contraído";
L_DHTMLLIB_selectedLab="Seleccionado";

L_DHTMLLIB_calendarNextMonthLab="Ir al mes siguiente";
L_DHTMLLIB_calendarPrevMonthLab="Ir al mes anterior";
L_DHTMLLIB_calendarNextYearLab="Ir al año siguiente";
L_DHTMLLIB_calendarPrevYearLab="Ir al año anterior";
L_DHTMLLIB_calendarSelectionLab="Día seleccionado";

L_DHTMLLIB_menuCheckLab="Activado";
L_DHTMLLIB_menuDisableLab="Desactivado";
	
L_DHTMLLIB_level="Nivel";
L_DHTMLLIB_closeTab="Cerrar ficha";
L_DHTMLLIB_of=" de ";

L_DHTMLLIB_helpLab="Ayuda";

L_DHTMLLIB_cancelButtonLab="Cancelar";

L_DHTMLLIB__modifiers= new Array();
L_DHTMLLIB__modifiers[0]="Ctrl+";
L_DHTMLLIB__modifiers[1]="Mayús+";
