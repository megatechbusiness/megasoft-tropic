...
var L_bobj_crv_Back = "Revenir";
var L_bobj_crv_Forward = "Avancer";
...
var L_bobj_crv_InvalidPageNumber = "Veuillez indiquer un num\u00E9ro de page sup\u00E9rieur \u00E0 0.";
var L_bobj_crv_ParamPanel = "Panneau d\'invite";
var L_bobj_crv_Parameters = "Param\u00E8tres";
var L_bobj_crv_GroupTree = "Arborescence des groupes";
var L_bobj_crv_Search = "Rechercher";
var L_bobj_crv_SearchResults = "R\u00E9sultats de la recherche";
var L_bobj_crv_DrillUp = "Explorer en arri\u00E8re";
var L_bobj_crv_DrillTo = "Explorer sur %1";
...
var L_bobj_crv_SearchText = "Rechercher";
var L_bobj_crv_SearchOptions = "Options de recherche";
var L_bobj_crv_Export = "Exporter le rapport";
var L_bobj_crv_Print = "Imprimer le rapport";
var L_bobj_crv_History = "Historique";
var L_bobj_crv_ClearHistory = "Effacer l\'historique";
var L_bobj_crv_TabList = "Liste des onglets";
var L_bobj_crv_Minimize = "R\u00E9duire";
var L_bobj_crv_Logo=  "Logo Business Objects";
var L_bobj_crv_FileMenu = "Menu Fichier";
var L_bobj_crv_ResultsFound = "{0} r\u00E9sultats trouv\u00E9s";
var L_bobj_crv_ResultsFoundInSubreport = "{0} r\u00E9sultats trouv\u00E9s dans {1}";
var L_bobj_crv_MatchWholeWordsOnly = "Mot entier uniquement";
var L_bobj_crv_MatchCase = "Respecter la casse";
var L_bobj_crv_FindMore = "En savoir plus";
var L_bobj_crv_Completed = "Termin\u00E9";
var L_bobj_crv_Breadcrumb= "Fil d\'Ariane";
...
var L_bobj_crv_PrintInfo1 = 'Le visualiseur doit \u00EAtre export\u00E9 au format PDF pour pouvoir \u00EAtre imprim\u00E9. Choisissez l\'option d\'impression dans le lecteur PDF une fois le document ouvert.';
...
var L_bobj_crv_ParamsApplyTip = "Appliquer les valeurs de param\u00E8tre";
var L_bobj_crv_ParamsDlgTitle = "Saisir les valeurs";
var L_bobj_crv_ParamsCalBtn = "Calendrier";
var L_bobj_crv_Reset= "R\u00E9initialiser";
var L_bobj_crv_ResetTip = "R\u00E9initialiser les valeurs de param\u00E8tre";
...
var L_bobj_crv_FlashRequired = "Ce contenu requiert Adobe Flash Player 11 ou version ult\u00E9rieure. {0}Veuillez cliquer ici pour commencer l\'installation.";
...
var L_bobj_crv_LastRefreshed = "Derni\u00E8re actualisation : {0}";

var L_bobj_crv_Collapse = "R\u00E9duire";

var L_bobj_crv_CatalystTip = "Ressources en ligne";
var L_bobj_crv_LoadingPage = "Chargement de la page {0}...";
var L_bobj_crv_TakeActionMenuTip = "S\u00E9lectionner une action li\u00E9e";
var L_bobj_crv_TakeActionExecuteActionError = "Un probl\u00E8me est survenu lors de l\'ex\u00E9cution de l\'action\u00A0; contactez votre administrateur.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(Aucune action disponible)";

var L_bobj_crv_API_InvalidArray = "{0} est de type Tableau";
var L_bobj_crv_API_InvalidBoolean = "\'{0}\' est de type Bool\u00E9en";
var L_bobj_crv_API_InvalidPageNumber = "Num\u00E9roPage est de type entier et sup\u00E9rieur \u00E0 0";
var L_bobj_crv_API_InstantiationFailed = "Une nouvelle instance de {0} doit \u00EAtre cr\u00E9\u00E9e.";
var L_bobj_crv_API_InvalidParamValue = "La valeur du champ de param\u00E8tre {0} n\'est pas valide.";
var L_bobj_crv_API_InvalidParamType = "Le type du champ de param\u00E8tre {0} n\'est pas valide. Veuillez s\u00E9lectionner un type valide dans SAP.CR.Parameter.DataTypes";
var L_bobj_crv_API_InvalidParamName = "Le nom du champ de param\u00E8tre doit \u00EAtre une cha\u00EEne d\'une longueur sup\u00E9rieure \u00E0 0.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} requiert {1} argument(s).";
var L_bobj_crv_API_InvalidValueType = "Le type de valeur attendu pour ce param\u00E8tre est {0}.";
var L_bobj_crv_API_InvalidCanvasListener= "L\'\u00E9couteur doit \u00EAtre une instance de SAP.CR.Viewer.CanvasListener";
var L_bobj_crv_API_InvalidActionListener= "L\'\u00E9couteur doit \u00EAtre une instance de SAP.CR.Viewer.ActionListener";
var L_bobj_crv_API_ValueTypeUndefined= "La propri\u00E9t\u00E9 paramType du champ de param\u00E8tre n\'est pas valide. Seules les valeurs de SAP.CR.Parameter.DataTypes.* sont prises en charge.";
var L_bobj_crv_API_InvalidRangeBound = "Les limites inf\u00E9rieure et sup\u00E9rieure peuvent utiliser uniquement des valeurs de SAP.CR.Parameter.RangeBoundTypes";
var L_bobj_crv_API_InvalidBeginValue = "La valeur de d\u00E9but n\'est pas valide";
var L_bobj_crv_API_InvalidEndValue = "La valeur de fin n\'est pas valide";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "La valeur de d\u00E9but doit \u00EAtre inf\u00E9rieure ou \u00E9gale \u00E0 la valeur de fin";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "Les valeurs des limites inf\u00E9rieure et sup\u00E9rieure ne peuvent pas \u00EAtre \u00E9gales \u00E0 SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "Les valeurs de d\u00E9but et de fin ne peuvent pas \u00EAtre \u00E9gales.";
var L_bobj_crv_API_InvalidColor = "La couleur \"{0}\" n\'est pas valide.";
var L_bobj_crv_API_InvalidResolution = "La r\u00E9solution {0} n\'est pas valide";
var L_bobj_crv_API_InvalidEventName = "{0} n\'est pas un \u00E9v\u00E9nement valide. Veuillez choisir un \u00E9v\u00E9nement \u00E0 partir de {1}";
var L_bobj_crv_API_InvalidViewerName = "Le nom du visualiseur \'{0}\' n\'est pas valide. Il doit commencer par une lettre et peut \u00EAtre suivi par un nombre de lettres ou de chiffres non d\u00E9fini.";
var L_bobj_crv_API_ViewerInitFailed = "Echec de l\'initialisation du visualiseur";
var L_bobj_crv_API_ViewerLoadFailed = "Impossible de charger le visualiseur.";

var L_bobj_crv_API_InvalidPrintMode = "{0} n\'est pas un mode d\'impression valide. Veuillez choisir un mode d\'impression \u00E0 partir de {1}";
var L_bobj_crv_API_InvalidReportMode = "{0} n\'est pas un mode Rapport valide. Choisissez un mode Rapport de {1}";
var L_bobj_crv_API_InvalidZoom = "{0} n\'est pas un niveau de zoom valide. ";
var L_bobj_crv_API_InvalidFunction = "Le premier argument doit \u00EAtre une fonction";
var L_bobj_crv_API_InvalidFunctionAfterInit = "Impossible d\'appeler \'{0}\' apr\u00E8s initialisation du visualiseur.";
// <script>
/*
=============================================================
...
L_DHTMLLIB_month[0]="JANVIER";
L_DHTMLLIB_month[1]="FEVRIER";
L_DHTMLLIB_month[2]="MARS";
L_DHTMLLIB_month[3]="AVRIL";
L_DHTMLLIB_month[4]="MAI";
L_DHTMLLIB_month[5]="JUIN";
L_DHTMLLIB_month[6]="JUILLET";
L_DHTMLLIB_month[7]="AOUT";
L_DHTMLLIB_month[8]="SEPTEMBRE";
L_DHTMLLIB_month[9]="OCTOBRE";
L_DHTMLLIB_month[10]="NOVEMBRE";
L_DHTMLLIB_month[11]="DECEMBRE";

L_DHTMLLIB_closeDialog="Fermer la fenêtre";

L_DHTMLLIB_openMenu="Cliquez ici pour accéder aux options {0}";

L_DHTMLLIB_expandedLab="Développé";
L_DHTMLLIB_collapsedLab="Réduit";
L_DHTMLLIB_selectedLab="Sélectionné";

L_DHTMLLIB_calendarNextMonthLab="Aller au mois suivant";
L_DHTMLLIB_calendarPrevMonthLab="Aller au mois précédent";
L_DHTMLLIB_calendarNextYearLab="Aller à l\'année suivante";
L_DHTMLLIB_calendarPrevYearLab="Aller à l\'année précédente";
L_DHTMLLIB_calendarSelectionLab="Jour sélectionné ";

L_DHTMLLIB_menuCheckLab="Activé";
L_DHTMLLIB_menuDisableLab="Désactivé";
	
L_DHTMLLIB_level="Niveau";
L_DHTMLLIB_closeTab="Fermer l\'onglet";
L_DHTMLLIB_of=" sur";

L_DHTMLLIB_helpLab="Aide";

L_DHTMLLIB_cancelButtonLab="Annuler";

L_DHTMLLIB__modifiers= new Array();
L_DHTMLLIB__modifiers[0]="Ctrl+";
L_DHTMLLIB__modifiers[1]="Maj+";
