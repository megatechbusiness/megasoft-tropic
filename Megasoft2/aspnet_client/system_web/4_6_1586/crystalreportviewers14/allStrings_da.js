...
var L_bobj_crv_Back = "G\u00E5 tilbage";
...
var L_bobj_crv_InvalidPageNumber = "Angiv et sidetal, der er st\u00F8rre end 0.";
var L_bobj_crv_ParamPanel = "Ledetekstpanel";
var L_bobj_crv_Parameters = "Parametre";
var L_bobj_crv_GroupTree = "Gruppetr\u00E6";
var L_bobj_crv_Search = "S\u00F8g";
var L_bobj_crv_SearchResults = "S\u00F8geresultater";
var L_bobj_crv_DrillUp = "Udled overordnede detaljer";
...
var L_bobj_crv_SearchText = "S\u00F8g";
var L_bobj_crv_SearchOptions = "S\u00F8geindstillinger";
var L_bobj_crv_Export = "Eksporter denne rapport";
var L_bobj_crv_Print = "Udskriv denne rapport";
var L_bobj_crv_History = "Historik";
var L_bobj_crv_ClearHistory = "Ryd historikken";
...
var L_bobj_crv_ResultsFound = "{0} resultater blev fundet";
var L_bobj_crv_ResultsFoundInSubreport = "{0} resultater blev fundet i {1}";
var L_bobj_crv_MatchWholeWordsOnly = "Kun hele ord";
var L_bobj_crv_MatchCase = "Forskel p\u00E5 store og sm\u00E5 bogstaver";
var L_bobj_crv_FindMore = "S\u00F8g efter flere";
var L_bobj_crv_Completed = "Fuldf\u00F8rt";
var L_bobj_crv_Breadcrumb= "Navigationssti";
...
var L_bobj_crv_ResetTip = "Nulstil parameterv\u00E6rdier";
...
var L_bobj_crv_paramsOpenAdvance = "Avanceret ledetekstknap til \'%1\'";
...
var L_bobj_crv_FlashRequired = "Dette indhold kr\u00E6ver Adobe Flash Player 11 eller h\u00F8jere. {0}Klik her for at installere.";
var L_bobj_crv_ReadOnlyInPanel= "Denne parameter kan ikke redigeres i dette panel. \u00C5bn den avancerede ledetekstdialog for at \u00E6ndre dens v\u00E6rdi";
...
var L_bobj_crv_AdvancedDialog_NoAjax= "Fremviseren kan ikke \u00E5bne en avanceret ledetekstdialog.";

var L_bobj_crv_EnableAjax= "Kontakt din administrator for at aktivere asynkrone anmodninger.";

var L_bobj_crv_LastRefreshed = "Senest opdateret: {0}";

var L_bobj_crv_Collapse = "Skjul";

var L_bobj_crv_CatalystTip = "Online-ressourcer";
var L_bobj_crv_LoadingPage = "Indl\u00E6ser side {0}...";
var L_bobj_crv_TakeActionMenuTip = "V\u00E6lg en bunden handling";
var L_bobj_crv_TakeActionExecuteActionError = "Der opstod et problem ved udf\u00F8relse af handlingen. Kontakt din administrator.";
...
var L_bobj_crv_TakeActionNoActionsMenuLabel = "(Ingen handlinger tilg\u00E6ngelige)";

var L_bobj_crv_API_InvalidArray = "\'{0}\' er af typen array";
var L_bobj_crv_API_InvalidBoolean = "\'{0}\' er af typen boolesk";
var L_bobj_crv_API_InvalidPageNumber = "\'sidetal\' er et heltal og st\u00F8rre end 0";
var L_bobj_crv_API_InstantiationFailed = "Ny forekomst af {0} skal oprettes.";
var L_bobj_crv_API_InvalidParamValue = "V\u00E6rdien af parameterfeltet \'{0}\' er ugyldigt.";
var L_bobj_crv_API_InvalidParamType = "Parameterfelttypen \'{0}\' er ugyldig. V\u00E6lg en gyldig type fra SAP.CR.Parameter.DataTypes";
var L_bobj_crv_API_InvalidParamName = "Navnet p\u00E5 parameterfeltet skal v\u00E6re en streng med en l\u00E6ngde p\u00E5 mere end 0.";

var L_bobj_crv_API_InvalidNumOfArguments = "{0} kr\u00E6ver {1} argument(er).";
var L_bobj_crv_API_InvalidValueType = "Den forventede v\u00E6rditype for denne parameter er \'{0}\'.";
var L_bobj_crv_API_InvalidCanvasListener= "Listener skal v\u00E6re en forekomst af SAP.CR.Viewer.CanvasListener";
var L_bobj_crv_API_InvalidActionListener= "Listener skal v\u00E6re en forekomst af SAP.CR.Viewer.ActionListener";
var L_bobj_crv_API_ValueTypeUndefined= "Parametertypeegenskaben for parameterfeltet er ikke gyldig. Kun v\u00E6rdier fra SAP.CR.Parameter.DataTypes.* underst\u00F8ttes.";
var L_bobj_crv_API_InvalidRangeBound = "Den \u00F8vre gr\u00E6nse og den nedre gr\u00E6nse kan kun bruge v\u00E6rdier fra SAP.CR.Parameter.RangeBoundTypes";
var L_bobj_crv_API_InvalidBeginValue = "Startv\u00E6rdien er ikke gyldig";
var L_bobj_crv_API_InvalidEndValue = "Slutv\u00E6rdien er ikke gyldig";
var L_bobj_crv_API_RangeBeginValueGreaterThanEndValue = "Startv\u00E6rdien skal v\u00E6re mindre end eller lig med slutv\u00E6rdien";
var L_bobj_crv_API_InvalidLowerAndUpperRangeBound = "V\u00E6rdien for b\u00E5de den nedre gr\u00E6nse og den \u00F8vre gr\u00E6nse m\u00E5 ikke v\u00E6re lig med SAP.CR.Parameter.DataTypes.UNBOUNDED";
var L_bobj_crv_API_InvalidBeginAndEndValue = "Start- og slutv\u00E6rdien m\u00E5 ikke v\u00E6re identiske.";
var L_bobj_crv_API_InvalidColor = "Farven \'{0}\' er ikke gyldig.";
var L_bobj_crv_API_InvalidResolution = "Opl\u00F8sningen {0} er ugyldig";
var L_bobj_crv_API_InvalidEventName = "\'{0}\' er ikke en gyldig h\u00E6ndelse. V\u00E6lg en h\u00E6ndelse fra {1}";
var L_bobj_crv_API_InvalidViewerName = "Fremvisernavnet \'{0}\' er forkert udformet. Det skal starte med et bogstav og kan efterf\u00F8lges af et hvilket som helst antal bogstaver eller cifre.";
var L_bobj_crv_API_ViewerInitFailed = "Kunne ikke initialisere fremviser";
var L_bobj_crv_API_ViewerLoadFailed = "Kunne ikke indl\u00E6se fremviser";

var L_bobj_crv_API_InvalidPrintMode = "\'{0}\' er ikke en gyldig udskrivningstilstand. V\u00E6lg en udskrivningstilstand fra {1}";
var L_bobj_crv_API_InvalidReportMode = "\'{0}\' er ikke en gyldig rapporttilstand. V\u00E6lg en rapporttilstand fra {1}";
var L_bobj_crv_API_InvalidZoom = "\'{0}\' er ikke et gyldigt zoomniveau";
var L_bobj_crv_API_InvalidFunction = "F\u00F8rste argument skal v\u00E6re en funktion";
var L_bobj_crv_API_InvalidFunctionAfterInit = "\'{0}\' kan ikke kaldes efter initialisering af fremviseren.";
// <script>
/*
=============================================================
...
L_DHTMLLIB_closeDialog="Luk vindue";

L_DHTMLLIB_openMenu="Klik her for at åbne {0}-indstillinger";

L_DHTMLLIB_expandedLab="Udvidet";
L_DHTMLLIB_collapsedLab="Skjult";
L_DHTMLLIB_selectedLab="Valgt";

L_DHTMLLIB_calendarNextMonthLab="Gå til næste måned";
L_DHTMLLIB_calendarPrevMonthLab="Gå til forrige måned";
L_DHTMLLIB_calendarNextYearLab="Gå til næste år";
L_DHTMLLIB_calendarPrevYearLab="Gå til forrige år";
L_DHTMLLIB_calendarSelectionLab="Valgt dag ";

L_DHTMLLIB_menuCheckLab="Markeret";
L_DHTMLLIB_menuDisableLab="Deaktiveret";
	
L_DHTMLLIB_level="Niveau";
L_DHTMLLIB_closeTab="Luk fane";
L_DHTMLLIB_of="af";

L_DHTMLLIB_helpLab="Hjælp";

L_DHTMLLIB_cancelButtonLab="Annuller";
