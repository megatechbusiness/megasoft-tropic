...
var L_bobj_crv_ResultsFoundInSubreport = "{0} resultaten gevonden in {1}";
...
L_DHTMLLIB_month[0]="Januari";
L_DHTMLLIB_month[1]="Februari";
L_DHTMLLIB_month[2]="Maart";
L_DHTMLLIB_month[3]="April";
L_DHTMLLIB_month[4]="Mei";
L_DHTMLLIB_month[5]="Juni";
L_DHTMLLIB_month[6]="Juli";
L_DHTMLLIB_month[7]="Augustus";
L_DHTMLLIB_month[8]="September";
L_DHTMLLIB_month[9]="Oktober";
L_DHTMLLIB_month[10]="November";
L_DHTMLLIB_month[11]="December";

L_DHTMLLIB_closeDialog="Venster sluiten";

L_DHTMLLIB_openMenu="Klik hier om opties voor {0} op te roepen";

L_DHTMLLIB_expandedLab="Uitgevouwen";
L_DHTMLLIB_collapsedLab="Samengevouwen";
L_DHTMLLIB_selectedLab="Geselecteerd";

L_DHTMLLIB_calendarNextMonthLab="Ga naar volgende maand";
L_DHTMLLIB_calendarPrevMonthLab="Ga naar vorige maand";
L_DHTMLLIB_calendarNextYearLab="Ga naar volgend jaar";
L_DHTMLLIB_calendarPrevYearLab="Ga naar vorig jaar";
L_DHTMLLIB_calendarSelectionLab="Geselecteerde dag";

L_DHTMLLIB_menuCheckLab="Ingeschakeld";
L_DHTMLLIB_menuDisableLab="Uitgeschakeld";
	
L_DHTMLLIB_level="Niveau";
L_DHTMLLIB_closeTab="Tabblad sluiten";
L_DHTMLLIB_of=" van ";

L_DHTMLLIB_helpLab="Help";

L_DHTMLLIB_cancelButtonLab="Annuleren";
